...
public class ShgMtg {
    ...
    private List<ShgGroupLoanTxn> shgGroupLoanTransactionList;
    //@anshul
    private List<ShgFinTxnVouchers> shgFinanceTransactionVouchersList;
	...
	public List<ShgMtgDet> getShgMeetingDetailsList() {
		return shgMeetingDetailsList;
	}

	public void setShgMeetingDetailsList(List<ShgMtgDet> shgMeetingDetailsList) {
		this.shgMeetingDetailsList = shgMeetingDetailsList;
	}

	public List<ShgFinTxn> getShgFinanceTransactionList() {
		return shgFinanceTransactionList;
	}

	public void setShgFinanceTransactionList(List<ShgFinTxn> shgFinanceTransactionList) {
		this.shgFinanceTransactionList = shgFinanceTransactionList;
	}

	public List<ShgFinTxnDetGrp> getShgFinanceTransactionDetailGroupList() {
		return shgFinanceTransactionDetailGroupList;
	}

	public void setShgFinanceTransactionDetailGroupList(List<ShgFinTxnDetGrp> shgFinanceTransactionDetailGroupList) {
		this.shgFinanceTransactionDetailGroupList = shgFinanceTransactionDetailGroupList;
	}

	public List<ShgGroupLoanTxn> getShgGroupLoanTransactionList() {
		return shgGroupLoanTransactionList;
	}

	public void setShgGroupLoanTransactionList(List<ShgGroupLoanTxn> shgGroupLoanTransactionList) {
		this.shgGroupLoanTransactionList = shgGroupLoanTransactionList;
	}

    public List<ShgFinTxnVouchers> getShgFinanceTransactionVouchersList() {
        return shgFinanceTransactionVouchersList;
    }
