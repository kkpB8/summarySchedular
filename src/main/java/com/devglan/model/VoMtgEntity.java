...
@Entity
@Table(name = "vo_mtg")
public class VoMtgEntity implements Serializable {

    private static final long serialVersionUID = 1L;
    public static final Integer approvalPending = 1;
    public static final Integer approvalAccept = 2;
    public static final Integer approvalReject = 3;
    ...
    public static Integer voCutOffMeeting1 = 11;
    public static Integer voCutOffMeeting2 = 12;

    public static long getSerialVersionUID() {
        return serialVersionUID;
    }

    public static Integer getApprovalPending() {
        return approvalPending;
    }

    public static Integer getApprovalAccept() {
        return approvalAccept;
    }

    public static Integer getApprovalReject() {
