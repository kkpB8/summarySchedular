...
@Repository
public interface MemberKYCDetailsDao extends JpaRepository<MemberKYCDetailsEntity, BigInteger> {
    @Query("FROM MemberKYCDetailsEntity c WHERE c.memberCode = :memberCode and c.cboId = :cboId")
