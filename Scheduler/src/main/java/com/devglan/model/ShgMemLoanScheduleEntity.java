 ...
 */
@Entity
@Table(name = "shg_mem_loan_schedule")
public class ShgMemLoanScheduleEntity implements Serializable {
    ...
    @Column(name = "shg_mem_loan_uid")
    private BigInteger shgMemberLoanUid;
    ...
    public BigInteger getShgMemberLoanUid() {
        return shgMemberLoanUid;
    }

    public void setShgMemberLoanUid(BigInteger shgMemberLoanUid) {
        this.shgMemberLoanUid = shgMemberLoanUid;
    }
