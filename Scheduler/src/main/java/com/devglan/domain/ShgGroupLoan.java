...
public class ShgGroupLoan {
    ...
    @Valid
    private List<ShgGroupLoanSchedule> shgGroupLoanScheduleList;
  ...
  //@anshul261121
    ...
    public List<ShgGroupLoanSchedule> getShgGroupLoanScheduleList() {
		return shgGroupLoanScheduleList;
	}

	public void setShgGroupLoanScheduleList(List<ShgGroupLoanSchedule> shgGroupLoanScheduleList) {
		this.shgGroupLoanScheduleList = shgGroupLoanScheduleList;
	}
